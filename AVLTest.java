...
public class AVLTest {
	...
	public static void main(String[] args) {
		...
		testOther();
		System.out.println();
		System.out.println("Self made tests: \n");
		testXiana();
	}
	
	private static void testXiana(){
		...
		// insert test
		avltree.insert(4); System.out.println("insert 4 "); avltree.inOrderTraversal(); System.out.println();
		avltree.insert(27); System.out.println("insert 27 "); avltree.inOrderTraversal(); System.out.println();
		avltree.insert(18); System.out.println("insert 18 "); avltree.inOrderTraversal(); System.out.println();
		avltree.insert(5); System.out.println("insert 5 "); avltree.inOrderTraversal(); System.out.println();
		avltree.insert(3); System.out.println("insert 3 "); avltree.inOrderTraversal(); System.out.println();
		avltree.insert(8); System.out.println("insert 8 "); avltree.inOrderTraversal(); System.out.println();
		avltree.insert(13); System.out.println("insert 13 "); avltree.inOrderTraversal(); System.out.println();
		avltree.insert(42); System.out.println("insert 42 "); avltree.inOrderTraversal();System.out.println();
		avltree.insert(26); System.out.println("insert 26 "); avltree.inOrderTraversal();System.out.println();
		avltree.insert(9); System.out.println("insert 9 "); avltree.inOrderTraversal();System.out.println();
		avltree.insert(15); System.out.println("insert 15 "); avltree.inOrderTraversal();System.out.println();
		avltree.insert(19); System.out.println("insert 19 "); avltree.inOrderTraversal();System.out.println();
		avltree.insert(10); System.out.println("insert 10 "); avltree.inOrderTraversal();System.out.println("\n-------------\n");
		avltree.insert(7); System.out.println("insert 7 "); avltree.inOrderTraversal();System.out.println("\n-------------\n");
		
		// remove test
		boolean rc = avltree.remove(4); System.out.println("remove 4, rc="+rc);avltree.inOrderTraversal();System.out.println("\n-------------\n");
		rc = avltree.remove(8); System.out.println("remove 8, rc="+rc);avltree.inOrderTraversal();System.out.println("\n-------------\n");
		
		//Remove case 3,double rotation
		rc = avltree.remove(13); System.out.println("remove 13, rc="+rc+", Balance the right sub-tree, case 3"); avltree.inOrderTraversal();System.out.println("\n-------------\n");
		rc = avltree.remove(1); System.out.println("remove 1, rc="+rc+", not exist"); avltree.inOrderTraversal();System.out.println("\n-------------\n");
		...
		System.out.println("avltree.countOccurrences(24) = " + avltree.countOccurrences(53));
